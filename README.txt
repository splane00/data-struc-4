...
Project structure:
- driver.py           : main entrypoint (CLI)
- quicksort.py        : iterative quicksort variants (4)
- insertion.py        : insertion sort helper (subrange)
- natural_merge.py    : linked-list natural merge sort (iterative)
- counters.py         : shared comparisons/exchanges counters
- rng.py              : deterministic RNG + Fisher–Yates shuffle
- io_utils.py         : file I/O, input generation, validation, checksum
